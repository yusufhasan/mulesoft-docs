...
. Download the Windows Gateway Services installer from link:https://repository-master.mulesoft.org/nexus/content/repositories/releases/org/mule/modules/anypoint-windows-gateway-service/1.12.0/anypoint-windows-gateway-service-1.12.0.zip[here]. Unzip the software distribution.
...
Note: Windows Gateway Services must be installed in the same domain as the Microsoft Dynamics AX 2012 environment in order to establish connectivity.
...
For more information on the MSMQ connector, see the link:/mule-user-guide/v/3.8/msmq-connector-user-guide[MSMQ Connector User Guide].
...
For more information on the PowerShell connector, see the link:/mule-user-guide/v/3.8/windows-powershell-connector-guide[Windows PowerShell Connector Guide].
